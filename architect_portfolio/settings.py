"""
Django settings for architect_portfolio project.
...
ROOT_URLCONF = 'architect_portfolio.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['architect_portfolio/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'architect_portfolio.wsgi.application'
